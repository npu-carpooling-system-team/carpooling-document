...
| driver_expire_date | datetime 司机证件过期时间    |         |                                  |
| avg_score          | tinyint 司机评分             |         |                                  |
...
| departure_campus | varchar10 出发校区              |         | not null default 长安校区 Enum   |
| arrive_campus    | varchar10 到达校区              |         | not null default 友谊校区 Enum   |
